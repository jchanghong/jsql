...
//    }
    ...
    public static Object getdata(OConnection c) {
        OElement element = new ODocument();
        element.setProperty("DATABASE()", c.schema == null ? "null" : c.schema);
        return new MyResultSet(Collections.singletonList(element), Collections.singletonList("DATABASE()"));
    }
}