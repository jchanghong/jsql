...
//
//    public static void response(String stmt, OConnection c, int rs) {
//        if (-1 == stmt.indexOf(',')) {
//            /* 单个属性 */
...
//    }
//
//    private static void oneSetResponse(String stmt, OConnection c, int rs) {
...
//    }
//
//    private static void multiSetResponse(String stmt, OConnection c, int rs) {
...
//    }
//
//    private static void setCharset(String charset, OConnection c) {
