 ...
 * @author jsql
 */
public class MSessionIncrement {
    ...
    public static Object getdata() {
        ...
        return new MyResultSet(Collections.singletonList(element), Collections.singletonList("@@session.auto_increment_increment"));
    }
}